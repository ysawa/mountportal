...
describe TreksController do
  ...
  # Trek. As you add validations to Trek, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) { { "name" => "MyString" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # TreksController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET show" do
    it "assigns the requested trek as @trek" do
      trek = Trek.create! valid_attributes
      get :show, {:id => trek.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested trek as @trek" do
      trek = Trek.create! valid_attributes
      get :edit, {:id => trek.to_param}, valid_session
      assigns(:trek).should eq(trek)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Trek" do
        expect {
          post :create, {:trek => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved trek as @trek" do
        ...
        post :create, {:trek => { "name" => "invalid value" }}, valid_session
        assigns(:trek).should be_a_new(Trek)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested trek" do
        ...
        put :update, {:id => trek.to_param, :trek => { "name" => "MyString" }}, valid_session
      end

      it "assigns the requested trek as @trek" do
        trek = Trek.create! valid_attributes
        put :update, {:id => trek.to_param, :trek => valid_attributes}, valid_session
        assigns(:trek).should eq(trek)
      end
    ...
    describe "with invalid params" do
      it "assigns the trek as @trek" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Trek.any_instance.stub(:save).and_return(false)
        put :update, {:id => trek.to_param, :trek => { "name" => "invalid value" }}, valid_session
        assigns(:trek).should eq(trek)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested trek" do
      trek = Trek.create! valid_attributes
      expect {
        delete :destroy, {:id => trek.to_param}, valid_session
      }.to change(Trek, :count).by(-1)
    end
